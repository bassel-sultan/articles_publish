        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <span class="text-white">Our Site</span>
                    <h1 class="text-capitalize mb-4 text-lg">The articles</h1>
                    <ul class="list-inline">
                        <li class="list-inline-item"><a href="index.html" class="text-white">Home</a></li>
                        <li class="list-inline-item"><span class="text-white">/</span></li>
                        <li class="list-inline-item text-white-50">Our Site</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 col-md-6 mb-5">
                    <div class="blog-item">
                        ...
                        <div class="blog-item-content bg-white p-5">
                            ...
                            <p class="mb-4">{{ Str::limit($blog->description,20,'...') }}</p>
