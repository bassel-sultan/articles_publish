      ...
      <div class="row justify-content-between align-items-center">
        ...
        <div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
          <div class="header-top-info mb-2 mb-md-0">
            <a href="tel:+23-345-67890">Call Us : <span>+963-933538503</span></a>
        ...
        <div class="col-lg-12" >
          <nav class="navbar navbar-expand-lg  px-0 py-4 " >
            <a class="navbar-brand" href="{{ url('/') }}">
              AlSULTAN<span>honey.</span><br><br>
            </a>
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown @@about">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown03">
                    <li><a class="dropdown-item @@company" href="#">Our company</a></li>
                ...
                <li class="nav-item @@contact"><a class="btn btn-solid-border btn-round-full" href="{{ route('login') }}">Login</a></li>
                <li class="nav-item @@contact"><a class="btn btn-solid-border btn-round-full" href="{{ route('register') }}">Register</a></li>
